...
$pdf->Cell(
    0,
    6,
    'SAMAHAN NG MGA PERSONS WITH DISABILITY NG BRGY. STO. NIÑO QC',
    0,
    1,
    'C'
);
...
while($row = mysqli_fetch_assoc($result)) {
    ...
    $remarks =
        strtoupper(substr(
            $row['disability_remarks'],
            0,
            16
        ));

    $disability =
        strtoupper($row['disablity_type']);
