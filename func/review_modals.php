...
<script>
  ...
  document.getElementById('rejectForm').addEventListener('submit', function(e) {
    ...
    if (reason.trim() !== "" && currentRecordId) {
        // Ensure this points to Needs Correction
        window.location.href = `func/updateStatus.php?id=${currentRecordId}&status=Needs Correction&reason=${encodeURIComponent(reason)}`;
    }
});
