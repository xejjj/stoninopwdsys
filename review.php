...
<main class="main-content">
  ...
  <button class="filter-btn <?php echo $filter === 'Pending' ? 'active' : ''; ?>" onclick="window.location.href='review.php?filter=Pending'">Pending</button>
  <button class="rejectedfilter-btn <?php echo $filter === 'Rejected' ? 'active' : ''; ?>" onclick="window.location.href='review.php?filter=Rejected'">Rejected</button>
  <button class="allfilter-btn <?php echo $filter === 'All' ? 'active' : ''; ?>" onclick="window.location.href='review.php?filter=All'">All</button>
</div>
    ...
    <div class="submission-card">
      <div class="sub-header">
        ...
        <div class="sub-actions">
          ...
          <button class="btn btn-reject" onclick="window.location.href='func/updateStatus.php?id=<?php echo $resident['id']; ?>&status=Rejected'">
